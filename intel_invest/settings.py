"""
Django settings for intel_invest project.
...
ALLOWED_HOSTS = ['intel-invest-app.herokuapp.com', '127.0.0.1', 'localhost']
...
ROOT_URLCONF = 'intel_invest.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'd7gbmstgpk0tlh',
        'USER': 'akfgckxkpichde',
        'PASSWORD': '554bd4be67685824a8a531a92f7a12aaf83d904f202e29f5b0778c91d44fb511',
...
# Twilio SendGrid
COMPANY_EMAIL=['intelinvestcontact@gmail.com', ]
